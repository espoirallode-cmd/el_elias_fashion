      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {filtered.map((p, i) => (
            <div
              key={p.name}
              className="bg-dark-card rounded-lg overflow-hidden border border-transparent hover:border-gold/50 hover:shadow-gold hover:-translate-y-1 transition-all duration-300 group w-[165px] sm:w-[240px] md:w-[200px] lg:w-[190px] xl:w-[180px]"
              ...
              {active === "Tous" && (
                <div className="p-4">
                  ...
                  <button 
                    ...
                    className="w-full font-body text-[10px] uppercase tracking-widest py-1 md:py-1.5 border border-gold/40 text-foreground rounded-sm hover:bg-gold hover:text-background transition-all duration-300"
                  >
                    Voir plus
                  </button>
                </div>
