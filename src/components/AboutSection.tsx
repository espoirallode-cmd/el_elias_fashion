  ...
  return (
    <section id="about" ref={ref} className="pt-10 pb-24 bg-background">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10 lg:gap-24 max-w-7xl mx-auto">
          {/* Image */}
          <div
          ...
          <div
            ref={textRef}
            className={`w-full lg:max-w-xl xl:max-w-2xl transition-all duration-1000 delay-300 ${
